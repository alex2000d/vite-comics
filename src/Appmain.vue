...
<template lang="">
        <div class="jumbotron">
            <img src="../src/assets/img/jumbotron.jpg" />
        </div>
    <div class="bg-dark">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-3" v-for="pasta, index in pastas" :key="index">
                    <div class="card m-3" style="width: 18rem;">
                        <img src="../src/assets/img/jumbotron.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                          <p class="card-text"></p>
                        </div>
                      </div>
